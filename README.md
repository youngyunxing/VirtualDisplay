...
- 点击菜单栏图标：打开统一面板，选择/切换显示器、管理分辨率预设、切换设置
- 「多分辨率模式」开关针对当前显示器，开启时可同时激活多个分辨率；关闭时只能激活一个
...
2. **点击**菜单栏图标打开统一面板：
   - 顶部是显示器列表，点击即可切换当前要管理的显示器。
   - 点击 **添加显示器...** 可创建新的虚拟显示器；新显示器拥有独立的默认预设。
3. 在「当前：XXX」区域管理选中显示器的内容：
   ...
   - 勾选或取消 **多分辨率模式** 切换单选/多选行为。
   - **重命名当前显示器...** / **删除当前显示器** 用于管理显示器本身（最后一个显示器不可删除）。
